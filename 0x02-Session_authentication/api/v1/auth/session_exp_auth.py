...
class SessionExpAuth(SessionAuth):
    ...
    This class inherits from SessionAuth and adds the functionality of session expiration
    ...
    def __init__(self):
        ...
        the session duration based on the SESSION_DURATION environment variable.
        If the environment variable is missing or invalid, a default of 0 is used.
    ...
    def create_session(self, user_id=None):
        ...
        This method overloads the parent method and adds the session creation time
    ...
    def user_id_for_session_id(self, session_id=None):
        ...
        Returns:
            str or None: The associated user ID or None if the session is invalid.
        """
